...
## Project Structure
    ...
    ├── withered_shadow_31459  # Django project configurations
...
1. Clone this repo and `cd withered_shadow_31459`
...
2. Clone this repo and `cd withered_shadow_31459`
